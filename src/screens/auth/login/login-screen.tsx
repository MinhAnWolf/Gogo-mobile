    ...
    <>
      <View style={[BaseStyles.container, BaseStyles.mrTop40]}>
        ...
        <View style={[LoginStyles.content]}>
          ...
          <View style={[LoginStyles.formatScreenLogin, BaseStyles.boderRadius10]}>
            <TouchableOpacity style={styles.button} onPress={handleSubmit(onSubmit)}>
              <Text style={styles.buttonText}>Login here</Text>
            </TouchableOpacity>
          </View>
          <Text style={[BaseStyles.centerText, BaseStyles.mrTop20, BaseStyles.mrBot20]}>Forgot password</Text>
          ...
          <Text style={[BaseStyles.centerText, BaseStyles.mrTop20, BaseStyles.mrBot20]}>
